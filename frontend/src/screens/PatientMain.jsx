...
import CommentSection from "../components/CommentSection"; // Import a component for commenting
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto mt-4 max-w-2xl lg:mx-0">
          ...
          <Link to="/Patient/Post">
            <button className="mt-10 px-4 py-2 text-sm font-semibold text-white bg-gray-900 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring focus:ring-blue-300">
              분석하러 가기
            </button>
          </Link>
        </div>
